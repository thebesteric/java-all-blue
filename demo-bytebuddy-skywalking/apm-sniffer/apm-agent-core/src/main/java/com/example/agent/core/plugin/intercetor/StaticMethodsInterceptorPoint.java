...
import com.example.agent.core.plugin.enhance.StaticMethodsAroundInterceptor;
...
public interface StaticMethodsInterceptorPoint {
    ...
    /**
     * 获取被增强的方法的拦截器，必须实现 StaticMethodsAroundInterceptor
     *
     * @return String
     * @author wangweijun
     * @see StaticMethodsAroundInterceptor
