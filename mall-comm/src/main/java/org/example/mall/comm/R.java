...
public class R {
    ...
    // 真实错误
    private static final String REAL_MESSAGE = "realMsg";
    // 请求uri
    ...
    public R setRealMsg(String realMsg) {
        return this.put(REAL_MESSAGE, realMsg);
    }
    ...
    public static R error(int code, String message, String realMsg) {
        return initInstance(code, message, null).put(REAL_MESSAGE, realMsg);
    }

    public static R error(int code, String message, String realMsg, String otherInfo) {
        return initInstance(code, message, null).put(REAL_MESSAGE, realMsg).put(OTHER_INFO, otherInfo);
    }

    public static R error(int code, String message, String realMsg, String uri,
                          String requestParam, String queryParam, String headerParam) {
        return initInstance(code, message, null).put(REAL_MESSAGE, realMsg).put(REQUEST_URI, uri)
                .put(REQUEST_PARAM, requestParam)
                .put(QUERY_PARAM, queryParam)
                .put(HEADER_PARAM, headerParam);
    }

    public static R error(int code, String message, String realMsg, String uri,
                          String requestParam, String queryParam, String headerParam,Object data) {
        return initInstance(code, message, data).put(REAL_MESSAGE, realMsg).put(REQUEST_URI, uri)
                .put(REQUEST_PARAM, requestParam)
                .put(QUERY_PARAM, queryParam)
                .put(HEADER_PARAM, headerParam);
    }
